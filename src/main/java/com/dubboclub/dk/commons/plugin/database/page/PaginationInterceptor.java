package com.dubboclub.dk.commons.plugin.database.page;
...
import com.dubboclub.dk.commons.plugin.database.dialect.Dialect;
import com.dubboclub.dk.commons.plugin.database.dialect.MySqlDialect;
import com.dubboclub.dk.commons.plugin.database.dialect.OracleDialect;
import com.dubboclub.dk.commons.plugin.database.dialect.SqlServerDialect;
import com.dubboclub.dk.commons.util.ReflectUtil;
...
public class PaginationInterceptor implements Interceptor {
    ...
    public Object intercept(Invocation invocation) throws Throwable {
        ...
        if (page != null) {
            ...
            String pageSql = dialect.getPageSql(originalSql, page.getPageNo(), page.getPageSize(), page.getOrderBy(), page.getOrder());
            if (logger.isDebugEnabled()) {
                logger.debug(String.format("执行SQL如下 ： %s", pageSql));
            }
