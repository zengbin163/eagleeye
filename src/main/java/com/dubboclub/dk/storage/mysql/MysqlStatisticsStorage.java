...
public class MysqlStatisticsStorage implements StatisticsStorage,InitializingBean {
    ...
    @Override
    public StatisticsOverview queryApplicationOverview(String application, long start, long end, String key) {
        StatisticsOverview statisticsOverview = new StatisticsOverview();
        List<Statistics>  statisticses = statisticsMapper.queryApplicationOverview(application,"concurrent",start,end,key);
        fillConcurrentItem(statisticses,statisticsOverview);
        statisticses = statisticsMapper.queryApplicationOverview(application,"elapsed",start,end,key);
        fillElapsedItem(statisticses, statisticsOverview);
        statisticses = statisticsMapper.queryApplicationOverview(application,"failureCount",start,end,key);
        fillFaultItem(statisticses,statisticsOverview);
        statisticses = statisticsMapper.queryApplicationOverview(application,"successCount",start,end,key);
